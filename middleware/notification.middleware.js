        ...
        try {
          if (data.success) {
            ...
            if (data.bidPlaced && data.auction) {
              ...
              // Assuming you have a method to get top bidders
              const topBidders = data.auction.topBidders || [];
              
              await NotificationService.handleAuctionBid(auctionData, newBidData, topBidders);
            }
