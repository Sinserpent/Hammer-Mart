...
import { seedEmailTemplates } from '../utils/emailTemplateSeeder.js';
...
router.post('/seed-templates', async (req, res) => {
  try {
    ...
    res.json({ success: true, message: 'Email templates seeded successfully' });
  } catch (error) {
    ...
    try {
      ...
      res.json({
        ...
        auction: {
          ...
          topBidders: bidResult.topBidders // Array of top 5 bidders with email, bidAmount, bidderId
        },
        newBid: {
